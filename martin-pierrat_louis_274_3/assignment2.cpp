...
//#include "MaterialWorley.h"
#include "MiroWindow.h"
//#include "Bbox.h"
#include "Vector3.h"

/*Vector3 Bbox::MIN = Vector3(0);*/
//Vector3 Bbox::MAX = Vector3(0);
...
void
makeTeapotScene(char *filename, bool has_obj_normals)
{
    ...
    //Material* shy = new MaterialSample();

    TriangleMesh * teapot = new TriangleMesh;
    teapot->load(filename);
    //teapot->setObjNormals(has_obj_normals);
    addMeshTrianglesToScene(teapot, material);
    //Bbox::MIN = teapot->getMin();
    //Bbox::MAX = teapot->getMax();
...
makeBunny20Scene()
{
    ...
    mesh->load(bunny_path.c_str(), xform);
