...
Sphere::preCalc(void)
{
    float   xmin = m_center.x - m_radius;
    float   ymin = m_center.y - m_radius;
    float   zmin = m_center.z - m_radius;

    float   xmax = m_center.x + m_radius;
    float   ymax = m_center.y + m_radius;
    float   zmax = m_center.z + m_radius;
